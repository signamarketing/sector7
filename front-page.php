	...
	<main id="main" class="site-main">
		...
		<div class="container-fluid no-gutters">
			<div class="row row-container">
				<div class="col-lg-4 text-center services" data-aos="fade-up" data-aos-once="true" data-aos-anchor-placement="center-center">
					<picture>
			...
			<div class="row row-container" style="padding-top: 0px;">
				<div class="col-lg-6 text-center services-buttons" data-aos="fade-up" data-aos-once="true" data-aos-anchor-placement="center-center">
					<picture>
		...
		<!-- Bold Statement -->
		<div class="container-fluid no-gutter bold-statement-bg" data-aos="fade-up" data-aos-once="true" data-aos-anchor-placement="center-center">
		...
		<div class="container-fluid no-gutter hp-card-image-spacer">
			<div class="row row-container">
				...
				<div class="col-lg-6 fo1 f-center">
					<picture>
						<source data-srcset="/wp-content/themes/signa-starter/img/webp/scout-perspective-mockup-min.webp" type="image/webp" class="hp-card-image lazy" alt="app mockup image" data-aos="fade-left" data-aos-once="true" data-aos-anchor-placement="center-center">
						<source data-srcset="/wp-content/themes/signa-starter/img/scout-perspective-mockup-min.jpg" type="image/jpg" class="hp-card-image lazy" alt="app mockup image" data-aos="fade-left" data-aos-once="true" data-aos-anchor-placement="center-center"> 
						<img data-src="/wp-content/themes/signa-starter/img/scout-perspective-mockup-min.jpg" class="hp-card-image lazy" alt="app mockup image" data-aos="fade-left" data-aos-once="true" data-aos-anchor-placement="center-center">
          </picture>
				</div>
			</div>
		</div>
